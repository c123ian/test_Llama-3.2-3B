...
app = modal.App("llama-3-5-chatbot")  # Initialize Modal app
...
def chat():
    ...
    return Div(
        Div("Test", cls="text-xs font-mono absolute top-0 left-0 w-fit p-1 bg-red border-b border-red-500 rounded-tl-md rounded-br-md font-celtic"),
...
@app.function(
    image=image,
    # gpu=modal.gpu.L4(count=1),  # Configures GPU resources
